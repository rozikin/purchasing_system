...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 13, 2022 at 11:40 AM
...
(63, 'INSERT001', 'INSERTBOARD FO PACKAGING SET GRAY', 10, 0, 0, '5000', 'USD', 'pcs', 'Locals'),
(66, '123', 'Barcode Label', 12, 2, 2, '1000', 'IDR', 'pcs', 'Barcode Label Size M'),
(67, 'WC00333AD-JP', 'CARE LABEL', 4, 2, 2, '1000', 'IDR', 'pcs', 'CARE LABEL SIZE M BLACK');
...
('add item', 64, '555', '555', '4', '555', 'IDR', '555', '555', '2022-10-05 15:35:25', 'root@localhost'),
('update item', 64, '555', '555', '4', '555', 'IDR', '555', '555aaaaa', '2022-10-05 15:35:35', 'root@localhost'),
('update item', 63, 'INSERT001', 'INSERTBOARD FO PACKAGING SET GRAY', '10', '5000', 'USD', 'pcs', 'Locals', '2022-10-06 10:14:04', 'root@localhost'),
('add item', 65, '1', '1', '4', '1', 'IDR', '1', '1', '2022-10-06 10:14:28', 'root@localhost'),
('add item', 66, '123', 'Barcode Label', '12', '1000', 'IDR', 'pcs', 'Barcode Label Size M', '2022-10-11 14:27:48', 'root@localhost'),
('add item', 67, 'WC00333AD-JP', 'CARE LABEL', '4', '1000', 'IDR', 'pcs', 'CARE LABEL SIZE M BLACK', '2022-10-12 15:32:58', 'root@localhost');
...
(64, '555', '555', '4', '555', 'IDR', '555', '555aaaaa', '2022-10-05 15:35:40'),
(65, '1', '1', '4', '1', 'IDR', '1', '1', '2022-10-06 10:15:53');
...
(0, '-', 0, '', '', '', '', '', '', '', '', '', '', '0', '', '', '0', '', ''),
(1, 'PO120001', 2, '4', '09/15/2022', '09/15/2022', 'wherehouse', 'acct', 'rita', 'Process', '58,000,000', '0', '10', '5,800,000', '63,800,000', '63,800,000', '- Prices are subject to 11% VAT- Prices has included delivery to TIMW-Bawen Semarang- Rate KMK 14.963 (03 Ags - 09 Ags)', '- Prices are subject to 11% VAT <br>\r\n- Prices has included delivery to TIMW-Bawen Semarang <br>\r\n- Rate KMK 14.963 (03 Ags - 09 Ags) <br>', 'rozi@gmail.com'),
(2, 'PO120002', 2, '5', '09/15/2022', '09/15/2022', 'wherehouse', 'cccc', 'rita', 'Process', '44,000,000', '0', '11', '4,840,000', '48,840,000', '48,840,000', '0', '- Prices are subject to 11% VAT <br>\r\n- Prices has included delivery to TIMW-Bawen Semarang <br>\r\n- Rate KMK 14.963 (03 Ags - 09 Ags)', 'rozi@gmail.com'),
(3, 'PO120003', 1, '4', '09/17/2022', '09/17/2022', 'wherehouse', 'wherehouse', 'rita', 'Process', '18,000,000', '0', '0', '0', '18,000,000', '18,000,000', 'cartonn', 'ssssss', 'rozi@gmail.com'),
(4, 'PO1', 5, '4', '10/11/2022', '10/25/2022', 'Warehouse', 'Accecories', 'Litta', 'Process', '15,000,000', '0', '10', '1,500,000', '16,500,000', '16,500,000', 'For PO 359', '- Prices has included delivery to TIMW-Bawen Semarang <br>\r\n- Prices are subject to 11% VAT.<br>\r\n- BTMU Rate : 14.875 / USD', 'rozi@gmail.com'),
(5, 'PO120004', 4, '4', '10/12/2022', '10/19/2022', 'accessoris', 'accessoris', 'rita', 'Process', '20,000,000', '0', '10', '2,000,000', '22,000,000', '22,000,000', 'for mo 360', 'please send soon as posible', 'rozi@gmail.com'),
(6, 'TIMW/0001/PO/ VIII /2023', 6, '4', '10/12/2022', '10/26/2022', 'Warehouse', 'Warehouse', 'Nanda', 'Process', '42,000,000', '', '10', '4,200,000', '46,200,000', '46,200,000', 'For P0122-450525-009 (348M) Heattech crew neck S/S T-shirt', '- Prices has included delivery to TIMW-Bawen Semarang\r\n- Prices are subjected to VAT 11%', 'purchasing@gmail.com');
...
INSERT INTO `tb_purchase_order_detail` (`id`, `id_po`, `id_item`, `qty`, `total_price`) VALUES
(87, 5, 58, 4000, '20000000'),
(90, 4, 59, 1000, '5000000'),
(91, 4, 58, 2000, '10000000'),
(96, 1, 47, 9000, '18000000'),
(97, 1, 48, 8000, '40000000'),
(98, 3, 47, 9000, '18000000'),
(99, 2, 42, 9000, '36000000'),
(100, 2, 41, 8000, '8000000'),
(103, 6, 47, 6000, '12000000'),
(104, 6, 58, 6000, '30000000');
...
(115, '3', 58, 1000, ''),
(116, '4', 58, 4000, 'ok'),
(119, '5', 59, 1000, 'barcode Size XL'),
(120, '5', 58, 2000, 'barcode Size L'),
(124, '6', 47, 6000, 'Care label S'),
(125, '6', 41, 6000, 'Plastic Bag'),
(126, '6', 58, 6000, '');
...
(0, '-', '-', '-', '-', '', '', '', ''),
(1, 'P0122-450525-009 (348M)', '348M', '348M', '(01372F002L) JAPAN', '09/14/2022', 'Approve', 'S = 5900\r\nM = 1900\r\nL = 18000', 'rozi@gmail.com'),
(2, 'P0122-450525-010 (349M)', '349M', '349M', 'JAPAN', '09/14/2022', 'Approve', 'S=9000\r\nL=8000\r\nM=7000', 'rozi@gmail.com'),
(3, 'P0122-450525-010 (350M)', '350M', '350M', 'JAPAN', '10/10/2022', 'Request', 'MINTA', 'rozi@gmail.com'),
(4, 'PO0897(360)', '360', '360', 'WH', '10/10/2022', 'Approve', 'ODD', 'rozi@gmail.com'),
(5, 'P0122-450525-009 (359M)', '359', 'HEATTECH crew neck S/S T-shirt', 'Indonesia', '10/11/2022', 'Approve', 'S	5,980	7,000	12980\r\nM	19,020	16,060	35080\r\nL	18,000	17,000	35000\r\nXL	7,000	10,040	17040\r\n', 'ppic@gmail.com'),
(6, 'P0122-450525-009 (001M)', '001M23', 'HEATTECH crew neck S/S T-shirt', 'JAPAN', '10/12/2022', 'Approve', 'S	5,980	7,000	12980\r\nM	19,020	16,060	35080\r\nL	18,000	17,000	35000\r\nXL	7,000	10,040	17040\r\n', 'ppic@gmail.com');
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `v_purchase_order_detail`  AS  select `tb_purchase_order_detail`.`id` AS `ID`,`tb_purchase_order_detail`.`id_po` AS `id_po`,`tb_purchase_order_detail`.`id_item` AS `id_item`,`tb_purchase_order_detail`.`qty` AS `qty`,`tb_purchase_order_detail`.`total_price` AS `total_price`,`v_items`.`item_code` AS `item_code`,`v_items`.`item_description` AS `item_description`,`v_items`.`id_supplier` AS `id_supplier`,`v_items`.`supplier_name` AS `supplier_name`,`v_items`.`color` AS `color`,`v_items`.`size_code` AS `size_code`,`v_items`.`item_price` AS `item_price`,`v_items`.`Currency` AS `Currency`,`v_items`.`unit` AS `unit`,`v_items`.`remark` AS `remark` from (`tb_purchase_order_detail` join `v_items` on((`tb_purchase_order_detail`.`id_item` = `v_items`.`id_item`))) ;
...
--
ALTER TABLE `tb_purchase_order`
  MODIFY `id_po` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `tb_trim_order`
  MODIFY `id_trim` int(25) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
