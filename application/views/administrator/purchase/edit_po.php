                                                    ...
                                                    <table class="table table-bordered table-hover table-sm" style="width:100%" id="invoiceItem">
                                                        ...
                                                        <?php foreach ($podetil as $ft2) : ?>
                                                            ...
                                                            <tr class="po-item">
                                                                ...
                                                                <td>
                                                                    <input type="text" class="form-control  form-control-xs" name="item_price[]" id="<?php echo  $price; ?>" value="<?= $ft2['item_price'] ?>" readonly>
                                                                </td>
                                                                <td>
                                                                    <input type="number" name="qty[]" id="<?php echo  $qty; ?>" value="<?= $ft2['qty'] ?>" class="form-control  form-control-xs" autocomplete="off" onclick="klik0()" required>
                                                                </td>
                                                                <td class="total-prices">
                                                                    <input type="number" name="total_price[]" id="<?php echo  $remark; ?>" class="form-control  form-control-xs" autocomplete="off" readonly required>
                                                                </td>
                                                            </tr>
                                                            <!-- </tbody> -->
...
<script text="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.pilih_code_c1', function(e) {
            ...
            document.getElementById(item_detil_oks).value = ax + " / " + bx + " / " + cx + " / " + dx + " / " +
                ex;
