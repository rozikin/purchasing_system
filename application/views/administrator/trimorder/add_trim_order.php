                                        ...
                                        <div class="form-group row mb-1">
                                            ...
                                            <div class="col-sm-5">
                                                <input type="hidden" class="form-control form-control-sm" id="id_trim"
                                                    name="id_trim" required autofocus>

                                                <input type="text" class="form-control form-control-sm" id="trim_code"
                                                    name="trim_code" placeholder="trim_code" required autofocus>
                                            </div>
                                        </div>
                                        <div class="form-group row mb-1">
                                            <label for="trim_style" class="col-sm-4 col-form-label">MO</label>
                                            <div class="col-sm-5">
                                                <input type="text" class="form-control form-control-sm" id="trim_mo"
                                                    name="trim_mo" placeholder="mo" required>
                                            </div>
                                        </div>
                                        <div class="form-group row mb-1">
                                            ...
                                            <div class="col-sm-5">
                                                <input type="text" class="form-control form-control-sm" id="trim_style"
                                                    name="trim_style" placeholder="style" required>
                                            </div>
                                        </div>
                                        <div class="form-group row mb-1">
                                            ...
                                            <div class="col-sm-5">
                                                <input type="text" class="form-control form-control-sm"
                                                    id="trim_destination" name="trim_destination"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group date input-group-sm" id="reservationdate"
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            data-target="#reservationdate" name="trim_date"
                                                            id="trim_date" />
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <textarea class="form-control" rows="3" name="trim_remark"
                                                    id="trim_remark" placeholder="Enter remark ..."></textarea>
                                            </div>
                                        </div>
                                                            ...
                                                            <td>
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" name="item_code[]"
                                                                        ...
                                                                        autocomplete="off" onclick="cari_item()"
                                                                        required>
                        ...
                        <table id="example1" class="table table-hover table-bordered table-sm">
                            ...
                            <tbody>
                                ...
                                <tr class="pilih_code_c1" data-id="<?= $sm['id_item'] ?>"
                                    ...
                                    data-size="<?= $sm['size_code'] ?>" data-color="<?= $sm['color'] ?>">
                                    <th scope="row"><?= $i; ?></th>
                                    <td><?= $sm['item_code']; ?></td>
